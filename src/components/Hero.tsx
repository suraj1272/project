    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="block mt-2 bg-gradient-to-r from-indigo-600 to-violet-600 dark:from-indigo-400 dark:to-violet-400 text-transparent bg-clip-text">
          Suraj Buddodi
          </span>
        </h1>
        ...
        >
          I'm a passionate student with a love for technology and creative pursuits.
        </p>
