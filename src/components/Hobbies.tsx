  ...
  const hobbies = [
    {
      ...
      bgColor: "bg-gradient-to-br from-purple-500 to-indigo-600 dark:from-purple-700 dark:to-indigo-800"
    },
    {
      icon: <Gamepad2 className="w-10 h-10" />,
      title: "Gaming",
      description: "Strategy and adventure games are my favorites.",
      bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600 dark:from-emerald-700 dark:to-teal-800"
    },
    {
      icon: <BookOpen className="w-10 h-10" />,
      title: "Reading",
      description: "Science fiction and philosophy books.",
      bgColor: "bg-gradient-to-br from-amber-500 to-orange-600 dark:from-amber-700 dark:to-orange-800"
    },
    {
      icon: <Bike className="w-10 h-10" />,
      title: "Cycling",
      description: "Exploring new trails and city routes.",
      bgColor: "bg-gradient-to-br from-blue-500 to-cyan-600 dark:from-blue-700 dark:to-cyan-800"
    },
    {
      icon: <Camera className="w-10 h-10" />,
      title: "Photography",
      description: "Capturing landscapes and street life.",
      bgColor: "bg-gradient-to-br from-violet-500 to-purple-600 dark:from-violet-700 dark:to-purple-800"
    },
    {
      icon: <Utensils className="w-10 h-10" />,
      title: "Cooking",
      description: "Experimenting with international cuisines.",
      bgColor: "bg-gradient-to-br from-rose-500 to-pink-600 dark:from-rose-700 dark:to-pink-800"
    },
    {
      icon: <Plane className="w-10 h-10" />,
      title: "Traveling",
      description: "Exploring new cultures and destinations.",
      bgColor: "bg-gradient-to-br from-cyan-500 to-blue-600 dark:from-cyan-700 dark:to-blue-800"
    },
    {
      icon: <Palette className="w-10 h-10" />,
      title: "Painting",
      description: "Creating abstract and landscape art.",
      bgColor: "bg-gradient-to-br from-fuchsia-500 to-violet-600 dark:from-fuchsia-700 dark:to-violet-800"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {hobbies.map((hobby, index) => (
            <div 
              key={hobby.title}
              className={`group relative overflow-hidden rounded-xl shadow-lg transition-all duration-1000 delay-${index * 100} transform ${
                isInView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
              }`}
            >
              <div className={`${hobby.bgColor} h-full aspect-square flex flex-col items-center justify-center text-white p-6 transition-transform duration-500 transform group-hover:scale-110`}>
