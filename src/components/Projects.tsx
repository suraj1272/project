  ...
  const projects = [
    {
      ...
      description: "A full-featured e-commerce platform built with React and Node.js. Implements user authentication, product management, and secure payment processing.",
    ...
    },
    {
      ...
      description: "Real-time weather application that provides detailed forecasts, interactive maps, and severe weather alerts using multiple weather APIs.",
    ...
    },
    {
      ...
      description: "Collaborative task management tool with real-time updates, team collaboration features, and detailed analytics dashboard.",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div 
              key={project.title}
              className={`bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden transform transition-all duration-1000 delay-${index * 200} ${
                isInView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
