...
const Resume = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: "Created custom websites for clients using modern web technologies. Managed project timelines and client communications."
    }
  ];
  ...
  const education = [
    {
      ...
      period: "2021 - 2025",
      description: "Focusing on software development, algorithms, and data structures. Maintaining a strong academic record."
    }
  ];
        ...
        >
          ...
          <div className="space-y-6">
            {experiences.map((exp, index) => (
              ...
              >
                <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-2">{exp.title}</h4>
                <p className="text-indigo-600 dark:text-indigo-400 font-medium mb-2">{exp.company}</p>
                <p className="text-slate-600 dark:text-slate-400 mb-3">{exp.period}</p>
          ...
          <div className="space-y-6">
            {education.map((edu, index) => (
              ...
              >
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-3">{edu.period}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {certifications.map((cert, index) => (
              ...
              >
                ...
                <p className="text-slate-600 dark:text-slate-400">{cert.date}</p>
              </div>
            ))}
          </div>
        </div>
